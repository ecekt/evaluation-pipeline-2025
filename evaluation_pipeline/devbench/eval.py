...
if __name__ == "__main__":
    ...
    vv_file = f"evaluation_data/full_eval/devbench/evals/lex-viz_vocab/{model_name}.npy"
    ...
    trog_file = f"evaluation_data/full_eval/devbench/evals/gram-trog/{model_name}.npy"
    ...
    things_file = f"evaluation_data/full_eval/devbench/evals/sem-things/{model_name}.npy"
    np.save(f"evaluation_data/full_eval/devbench/evals/sem-things/{model_name}.npy", things_embeds)
